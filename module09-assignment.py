...
# Your code here
product_rev = sales_df.groupby('Product')['Total_Sales'].sum()
product_revenue_analysis = pd.DataFrame({
    'total_revenue': product_rev,
    'percentage': (product_rev/total_revenue)*100
})
...
print("1. Use better marketing in places with lower total revenue.")
print("2. Increase promotions on products like PhoneX to increase revenue.")
print("3. Bundle products to help increase order value.")